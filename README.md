...
<p align="center"><a href="https://heroku.com/deploy?template=https://github.com/syahrizalemano/2forcesubsidns">
  <img src="https://img.shields.io/badge/Deploy%20To%20Heroku-orange?style=flat&logo=heroku" width="325" height="50.100" /></a></p>
</a><br>

#### Deploy in your VPS
````bash
git clone https://github.com/syahrizalemano/2forcesubsidns
cd 2forcesubsidns
